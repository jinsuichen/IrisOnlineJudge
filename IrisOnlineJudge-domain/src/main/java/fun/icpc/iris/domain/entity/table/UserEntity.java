...
import fun.icpc.iris.domain.entity.mapping.MpGroupUser;
import fun.icpc.iris.domain.entity.mapping.MpTeamUser;
import fun.icpc.iris.domain.entity.mapping.MpTenantUser;
import fun.icpc.iris.sharedkernel.enums.CountryAndRegionTypeEnum;
import fun.icpc.iris.sharedkernel.enums.GenderTypeEnum;
