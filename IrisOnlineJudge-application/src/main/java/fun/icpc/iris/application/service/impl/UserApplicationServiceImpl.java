...
import fun.icpc.iris.application.command.LoginToken;
import fun.icpc.iris.application.dto.UserConverter;
...
import fun.icpc.iris.sharedkernel.exception.irisexception.SystemException;
import fun.icpc.iris.sharedkernel.util.IrisMessage;
import fun.icpc.iris.sharedkernel.util.IrisMessageFactory;
import fun.icpc.iris.sharedkernel.util.JsonUtils;
import fun.icpc.iris.sharedkernel.util.RedisConstantsUtils;
...
public class UserApplicationServiceImpl implements UserApplicationService {
    ...
    private String hashPasswordWithRandSalt(String password, String handle) {
        ...
        byte[] hashPassword = BCrypt.generate(DigestUtils.md5(password), saltBytes, 10);
